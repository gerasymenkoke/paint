...
// output  result as string with diferent length adding new symbols each cycle
     ...
     if( resnum[l] >= 10 ) { sresnum[l] = resnum[l]  }
      ...
      if( l==1 || resnum[l-1] == 14 )  { iresnum=resnum[l].toFloat() }              
         
       
                
      if(sign == 1  && resnum[l-1-shift1]==10) { iresnum= iresnum +  sresnum[l].toFloat(); asresnum = iresnum.toString() + ";" + sresnum[l].toString()  } 
      ...
      if(l>=1 && resnum[l]==14) { aresnum =  aresnum  + iresnum.toString() ; resnum[l+1]=iresnum.toInt(); f=1; iresnum=0.0f; sresnum[l+1]=resnum[l+1]; sign=0;  l=l+1 }
