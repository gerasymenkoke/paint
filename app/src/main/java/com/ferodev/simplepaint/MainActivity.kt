...
// 9
   ...
   rcanglenn_[9][3]=arrayOf<Float>(   7.0f,  29.0f,   59.0f,  75.0f, -96.0f, -112.0f,  -158.0f,    -9.0f,  -39.0f,  -56.0f,  -73.0f,  97.0f, 160.0f,   7.0f,  27.0f,   45.0f,360.0f, 360.0f, 360.0f, 360.0f  ) 
...
// -
      jj = 11               
        ...
        rcanglenn_[11][1]=arrayOf<Float>(   5.0f , 157.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  )
