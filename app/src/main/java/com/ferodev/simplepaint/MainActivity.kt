...
// 0
    ...
    rcanglenn_[0][2]=arrayOf<Float>(   58.0f,  77.0f,  93.0f,108.0f,  126.0f, 158.0f,   5.0f,  27.0f,  43.0f,  58.0f,  74.0f,  94.0f, 122.0f, 152.0f,  16.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  ) 
    rcanglenn_[0][3]=arrayOf<Float>(   23.0f,  44.0f,  66.0f, 95.0f,  118.0f, 144.0f,   5.0f,  35.0f,  52.0f,  70.0f,  85.0f,  94.0f, 113.0f, 135.0f, 154.0f,   8.0f,  32.0f, 360.0f, 360.0f, 360.0f  ) 
    rcanglenn_[0][4]=arrayOf<Float>(   78.0f,  57.0f,  40.0f, 20.0f,  169.0f, 139.0f, 121.0f, 104.0f,  84.0f,  67.0f,  50.0f,  30.0f, 176.0f, 151.0f, 130.0f, 106.0f,  82.0f,  66.0f, 360.0f, 360.0f  ) 
    rcanglenn_[0][5]=arrayOf<Float>(   51.0f,  71.0f,  92.0f, 111.0f, 132.0f, 153.0f, 173.0f,   8.0f,  31.0f,  58.0f,  75.0f,  92.0f, 139.0f, 157.0f,   8.0f,  37.0f, 360.0f, 360.0f, 360.0f, 360.0f  ) 
    rcanglenn_[0][6]=arrayOf<Float>(   85.0f,  92.0f, 112.0f, 171.0f,  13.0f,  42.0f,  59.0f,  78.0f,  94.0f, 110.0f, 131.0f,   9.0f,  57.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  ) 
    rcanglenn_[0][7]=arrayOf<Float>(   30.0f,  55.0f,  71.0f,  92.0f, 111.0f, 136.0f,  10.0f,  50.0f,  69.0f,  94.0f, 133.0f, 153.0f,   9.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  ) 
    rcanglenn_[0][8]=arrayOf<Float>(   29.0f,  55.0f,  77.0f,  93.0f, 114.0f, 134.0f, 158.0f,   4.0f,  44.0f,  59.0f,  78.0f,  92.0f, 111.0f, 134.0f, 151.0f, 174.0f, 360.0f, 360.0f, 360.0f, 360.0f  ) 
    rcanglenn_[0][9]=arrayOf<Float>(   28.0f,  49.0f,  64.0f,  82.0f,  93.0f, 113.0f, 134.0f, 158.0f,  13.0f,  40.0f,  57.0f,  72.0f,  92.0f, 142.0f, 162.0f,   5.0f, 360.0f, 360.0f, 360.0f, 360.0f  ) 
    rcanglenn_[0][10]=arrayOf<Float>(  45.0f,  28.0f, 167.0f, 140.0f, 117.0f,  88.0f,  67.0f,  44.0f,  21.0f, 172.0f, 137.0f, 116.0f,  96.0f,  85.0f,  63.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  ) 
    ...
    rcanglenn_[0][15]=arrayOf<Float>(  54.0f,  71.0f,  93.0f, 112.0f, 130.0f,   9.0f,  30.0f,  46.0f,  69.0f,  93.0f, 114.0f, 134.0f, 160.0f,  16.0f,  34.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  ) 
...
// 1
   ...
   rcanglenn_[1][2]=arrayOf<Float>(   43.0f,  67.0f,   82.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  ) 
   rcanglenn_[1][3]=arrayOf<Float>(   47.0f,  65.0f,  121.0f,  77.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  ) 
   rcanglenn_[1][4]=arrayOf<Float>(   52.0f,  68.0f,  105.0f,  81.0f,   6.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  ) 
...
// 2
 ...
 rcanglenn_[2][3]=arrayOf<Float>(   72.0f,   35.0f,  174.0f, 133.0f, 112.0f,  87.0f, 64.0f,  45.0f,  26.0f,  165.0f ,  66.0f, 15.0f, 171.0f, 142.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  ) 
 rcanglenn_[2][4]=arrayOf<Float>(   43.0f,   22.0f,  168.0f, 107.0f,  86.0f,  67.0f, 51.0f,  29.0f, 166.0f,    7.0f , 172.0f,156.0f,  19.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  ) 
 rcanglenn_[2][5]=arrayOf<Float>(   62.0f,   37.0f,    9.0f, 172.0f, 125.0f, 109.0f, 86.0f,  69.0f,  53.0f,   32.0f , 172.0f, 72.0f, 170.0f, 144.0f,  17.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  ) 
 rcanglenn_[2][6]=arrayOf<Float>(   66.0f,   48.0f,   21.0f, 173.0f, 117.0f,  86.0f, 70.0f,  52.0f, 174.0f,   67.0f ,  11.0f,169.0f, 148.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  ) 
 rcanglenn_[2][7]=arrayOf<Float>(   53.0f,   36.0f,  169.0f, 106.0f,  82.0f,  66.0f, 48.0f, 153.0f,  75.0f,  170.0f , 153.0f,360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  ) 
 rcanglenn_[2][8]=arrayOf<Float>(   57.0f,   40.0f,  173.0f, 115.0f,  86.0f,  67.0f, 50.0f,  31.0f, 168.0f,   43.0f , 176.0f,153.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  )     
 rcanglenn_[2][9]=arrayOf<Float>(   76.0f,   60.0f,   19.0f, 171.0f, 137.0f, 121.0f,100.0f,  85.0f,  68.0f,   44.0f ,  23.0f,173.0f,  78.0f, 171.0f, 146.0f,  14.0f, 360.0f, 360.0f, 360.0f, 360.0f  ) 
 rcanglenn_[2][10]=arrayOf<Float>(  80.0f,   54.0f,  172.0f, 122.0f,  96.0f,  82.0f, 63.0f,  48.0f,  30.0f,  156.0f ,  55.0f,168.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  )     
 rcanglenn_[2][11]=arrayOf<Float>(  65.0f,   43.0f,   15.0f, 174.0f, 142.0f, 102.0f, 86.0f,  66.0f,  50.0f,   17.0f ,  79.0f,170.0f, 150.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  ) 
...
// 3
  ...
  rcanglenn_[3][3]=arrayOf<Float>(   41.0f,  19.0f, 177.0f,  98.0f,  73.0f,   53.0f,   38.0f, 177.0f, 161.0f, 141.0f,  78.0f,  44.0f,  22.0f, 174.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  ) 
  rcanglenn_[3][4]=arrayOf<Float>(   67.0f,  46.0f, 176.0f, 127.0f, 102.0f,   83.0f,   64.0f,  43.0f,  26.0f, 176.0f, 139.0f, 118.0f,  83.0f,  45.0f,  27.0f,   5.0f, 360.0f, 360.0f, 360.0f, 360.0f  ) 
  rcanglenn_[3][5]=arrayOf<Float>(   47.0f,  25.0f, 176.0f, 102.0f,  74.0f,   57.0f,   37.0f,   6.0f, 170.0f, 138.0f, 115.0f,  85.0f,  44.0f,  19.0f, 174.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  ) 
  rcanglenn_[3][6]=arrayOf<Float>(  179.0f,  46.0f, 176.0f,  33.0f, 360.0f,  360.0f,  360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  ) 
...
// 6
  ...
  rcanglenn_[6][2]=arrayOf<Float>(    8.0f,  47.0f,   65.0f,  85.0f,  95.0f,  116.0f, 132.0f,  158.0f,  12.0f,   51.0f,  69.0f,  95.0f,  135.0f, 165.0f,    9.0f,  39.0f, 360.0f, 360.0f, 360.0f, 360.0f  ) 
  rcanglenn_[6][3]=arrayOf<Float>(   10.0f,  27.0f,   45.0f,  62.0f,  84.0f,   96.0f, 113.0f,  129.0f, 149.0f,    6.0f,  46.0f,  66.0f,   95.0f, 121.0f,  143.0f, 167.0f,   8.0f,  38.0f,  56.0f,   0.0f  ) 
  rcanglenn_[6][4]=arrayOf<Float>(    4.0f,  26.0f,   46.0f,  66.0f,  86.0f,   99.0f, 116.0f,  144.0f, 161.0f,    7.0f,  35.0f,  57.0f,   72.0f,  99.0f,  124.0f, 141.0f, 159.0f,   9.0f,  37.0f, 360.0f  ) 
  rcanglenn_[6][5]=arrayOf<Float>(    4.0f,  40.0f,   57.0f,  77.0f,  93.0f,  111.0f, 130.0f,  156.0f,  10.0f,   44.0f,  67.0f,  84.0f,   98.0f, 117.0f,  148.0f,   4.0f,  37.0f, 360.0f, 360.0f, 360.0f  ) 
  ...
  rcanglenn_[6][10]=arrayOf<Float>(   6.0f,  24.0f,   45.0f,  63.0f,  81.0f,   94.0f, 124.0f,  142.0f, 166.0f,    8.0f,  28.0f,  51.0f,   72.0f,  94.0f,  130.0f, 146.0f,   6.0f,  28.0f,  54.0f, 360.0f  ) 
  rcanglenn_[6][11]=arrayOf<Float>(   7.0f,  30.0f,   49.0f,  65.0f,  80.0f,   97.0f, 116.0f,  132.0f, 154.0f,    7.0f,  41.0f,  60.0f,   75.0f,  94.0f,  126.0f, 156.0f,  12.0f,  50.0f,  68.0f, 360.0f  ) 
...
// 7
   ...
   rcanglenn_[7][4]=arrayOf<Float>(   67.0f,   30.0f, 165.0f,  138.0f, 155.0f,   7.0f,  51.0f,  77.0f, 124.0f, 173.0f , 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f ) 
...
// 8
    ...
    rcanglenn_[8][6]=arrayOf<Float>(    147.0f,  130.0f,   82.0f,  52.0f,  32.0f,  13.0f, 173.0f,  82.0f,   59.0f,   75.0f,125.0f, 156.0f,    7.0f,  53.0f,  78.0f,  96.0f, 125.0f, 143.0f, 360.0f, 360.0f  )    
...
// 9
   ...
   rcanglenn_[9][3]=arrayOf<Float>(     29.0f,  45.0f,   61.0f,  82.0f,  94.0f, 138.0f,  167.0f,    5.0f,  25.0f,  42.0f,  59.0f,  76.0f,   95.0f, 160.0f,   8.0f,  32.0f, 360.0f, 360.0f, 360.0f, 360.0f  ) 
   rcanglenn_[9][4]=arrayOf<Float>(      7.0f,  44.0f,   63.0f,  78.0f,  93.0f, 115.0f,  133.0f,    7.0f,  30.0f,  58.0f,  75.0f,  93.0f,  130.0f, 160.0f,   7.0f,  24.0f, 360.0f, 360.0f, 360.0f, 360.0f  ) 
   rcanglenn_[9][5]=arrayOf<Float>(    143.0f,   7.0f,   49.0f,  66.0f,  93.0f, 114.0f,  141.0f,   10.0f,  65.0f, 101.0f, 130.0f,   5.0f,   31.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  ) 
   rcanglenn_[9][6]=arrayOf<Float>(    146.0f, 166.0f,    8.0f,  38.0f,  57.0f,  73.0f,   93.0f,  119.0f, 149.0f,  11.0f,  45.0f,  63.0f,   79.0f,  97.0f, 131.0f, 153.0f,   5.0f,  27.0f,  48.0f, 360.0f  ) 
   ...
   rcanglenn_[9][11]=arrayOf<Float>(    13.0f,  30.0f,   50.0f,  68.0f,  84.0f,  97.0f,  131.0f,  148.0f, 165.0f,  18.0f,  52.0f,  73.0f,   94.0f, 115.0f, 141.0f,   5.0f,  29.0f,  48.0f, 360.0f, 360.0f  ) 
...
// +
      ...
      rcanglenn_[10][1]=arrayOf<Float>(     1.0f,  136.0f,  360.0f,  360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  )  
 //     rcanglenn_[10][2]=arrayOf<Float>(    48.0f,   81.0f,  360.0f,  360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  )  
      rcanglenn_[10][2]=arrayOf<Float>(     3.0f,  130.0f,   87.0f,   92.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  )  
      rcanglenn_[10][3]=arrayOf<Float>(   177.0f,   83.0f,  360.0f,  360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  )  
 ...
 //     rcanglenn_[10][6]=arrayOf<Float>(    47.0f,   78.0f,  360.0f,  360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  )  
      ...
      rcanglenn_[10][7]=arrayOf<Float>(   178.0f,  125.0f,   84.0f,   95.0f,  78.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  )  
...
// x
      jj = 12               
  rcanglenn_[12][0]=arrayOf<Float>(   137.0f,  92.0f,   46.0f,  62.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  )  
  rcanglenn_[12][1]=arrayOf<Float>(   125.0f,  87.0f,   51.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  )  
  rcanglenn_[12][2]=arrayOf<Float>(    46.0f,  18.0f,  138.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  )  
  rcanglenn_[12][3]=arrayOf<Float>(   123.0f,  85.0f,   46.0f,  62.0f,  45.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  )  
  rcanglenn_[12][4]=arrayOf<Float>(    49.0f,  16.0f,  137.0f, 121.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  )  
...
// /
      ...
      rcanglenn_[13][1]=arrayOf<Float>(   52.0f,  37.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f , 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  )  
...
// =
     ...
     rcanglenn_[14][0]=arrayOf<Float>(   175.0f,  28.0f,  175.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  )  
     rcanglenn_[14][1]=arrayOf<Float>(   176.0f,  40.0f,  360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  )
     rcanglenn_[14][2]=arrayOf<Float>(   114.0f, 175.0f,  360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  )
     rcanglenn_[14][3]=arrayOf<Float>(   179.0f,  33.0f,  174.0f,   9.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  )  
     rcanglenn_[14][4]=arrayOf<Float>(    96.0f, 170.0f,  360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  )
