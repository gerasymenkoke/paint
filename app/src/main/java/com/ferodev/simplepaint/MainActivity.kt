...
// output  result as string with diferent length adding new symbols each cycle
     ...
     if( resnum[l] >= 10 ) { sresnum[l] = resnum[l]  }
      ...
      if(sign == 1  && resnum[l-1-shift1]==12) { if (shift1==0 && ffr==0) { xiresnum= sresnum[l-2].toFloat() * sresnum[l].toFloat()  
                                                                if (sresnum[l-2] >0) { iresnum= iresnum - sresnum[l-2].toFloat() }
                                                                if (sresnum[l-2] <=0) { iresnum= iresnum + sresnum[l-2].toFloat() }                        
                                                                                        ffr=1} 
...
textviewid.text =     "  " + aresnum +  "\n" +
                    ...
                    "\n" +  aaa[0] + " " +aaa[1] + " " + aaa[2] + " " + aaa[3] + " " + aaa[4] + " " + aaa[5] + " " + aaa[6] + " " + aaa[7] + " " + aaa[8] + " " + aaa[9]  +
                     " iresnum=" + iresnum +  " xiresnum=" + xiresnum +   " shift1=" + shift1 +  " sign=" + sign + " l=" + l + " f=" + f + " ff=" + ff + " ffr=" + ffr +
