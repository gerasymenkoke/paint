...
textviewid.text =    "result=" + result +  "\n"  + "  res[0][0]=" + res[0][0] + "  res[0][1]=" + res[0][1] + "  res[0][2]=" + res[0][2] + "  res[0][3]=" + res[0][3] + "  res[1][0]=" + res[1][0] + "  res[1][1]=" + res[1][1] + "  res[1][2]=" + res[1][2] + "  res[1][3]=" + res[1][3] + "  res[1][4]=" + res[1][4] + "  res[2][0]=" + res[2][0] + "  res[2][1]=" + res[2][1] + "  res[2][2]=" + res[2][2] + "  res[2][3]=" + res[2][3] + "  res[2][4]=" + res[2][4] +
