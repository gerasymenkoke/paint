...
/*     aaa = Array<String>(800){"0"} // text Array for result monitoring
     ...
     minres = 100000 // temporary variable  resmin[jj] [j] < minres
     minres0 = 100000 
     ...
     res00 = 0 
     res1 = 0 // look up
     l = 0 // counter for different res0 in resnum array
     resnum =  Array<Int>(60){30}  // result each cycle adding  as Int Array
     sresnum =  Array<Int>(60){30}  // result each cycle adding  as Int Array
     asresnum = " "  
 
     
     iresnum = 0 // result last operation

    
     xiresnum = 0  // result last operation x or /
     aresnum = " "                 // result each cycle adding as String
     aresnum1 = ""  
