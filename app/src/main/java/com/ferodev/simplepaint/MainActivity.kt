...
// 0
     jj = 0                  
     dir_rr[0][0] = arrayOf<Int>(  0,  1,  0,  3,  2,  3, 10, 10, 10, 10)
     dir_rr[0][1] = arrayOf<Int>(  0,  3,  0,  1,  2,  3, 10, 10, 10, 10)
     dir_rr[0][2] = arrayOf<Int>(  0,  2,  1,  0,  3,  2,  3, 10, 10, 10)   
     
 // Filling sample array
// 1
      jj = 1                  
     dir_rr[1][0] = arrayOf<Int>(  0,  3,  1,  3, 10, 10, 10, 10, 10, 10)
     dir_rr[1][1] = arrayOf<Int>(  0,  3,  0,  3, 10, 10, 10, 10, 10, 10)
     dir_rr[1][2] = arrayOf<Int>(  0,  3,  0,  1,  3, 10, 10, 10, 10, 10)
...
textviewid.text = "result=" + result +  "\n"  + "  res[0][0]=" + res[0][0] + "  res[0][1]=" + res[0][1] + "  res[0][2]=" + res[0][2] + "  res[1][0]=" + res[1][0] + "  res[1][1]=" + res[1][1] + "  res[1][2]=" + res[1][2]  + "  res[2][0]=" + res[2][0] + "  res[2][1]=" + res[2][1] + "  res[2][2]=" + res[2][2] +
                    ...
                    aaacr[0] + " " +aaacr[10] + " " + aaacr[11] + " " + aaacr[12] + " " + aaacr[13] + " " + aaacr[14] + " " + aaacr[15] + " " + aaacr[16] + " " + aaacr[17] + " " + aaacr[18] + " " + aaacr[19]
