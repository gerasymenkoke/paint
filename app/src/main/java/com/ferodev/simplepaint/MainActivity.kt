...
// 2
 ...
 rcanglenn_[2][10]=arrayOf<Float>(  78.0f,   41.0f,  166.0f, 131.0f, 109.0f, -82.0f, -63.0f,  -36.0f, -168.0f,  75.0f ,  26.0f, 167.0f, 131.0f,  45.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  ) 
...
// 3
  ...
  rcanglenn_[3][10]=arrayOf<Float>(  56.0f,  31.0f, 172.0f, 111.0f,  -83.0f,  -59.0f, -39.0f, 173.0f, 150.0f, 127.0f, 105.0f, -83.0f,  -45.0f,  -23.0f,  -8.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  ) 
  rcanglenn_[3][11]=arrayOf<Float>(  78.0f,  37.0f,  14.0f, 168.0f,  112.0f,  -82.0f, -55.0f, -40.0f, 173.0f, 150.0f, -84.0f, -48.0f,  -29.0f,  -13.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  ) 
  rcanglenn_[3][12]=arrayOf<Float>(  41.0f,  20.0f, 175.0f, -82.0f,  -54.0f,  -36.0f,  14.0f, 169.0f, 141.0f, -82.0f, -34.0f,-178.0f,  360.0f,  360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  ) 
  rcanglenn_[3][13]=arrayOf<Float>(  50.0f,  34.0f, 164.0f, 118.0f,  -81.0f,  -63.0f, -45.0f, -24.0f, 171.0f, 132.0f, 112.0f, -78.0f,  -23.0f,  360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  ) 
...
// 4
  ...
  rcanglenn_[4][8]=arrayOf<Float>(  -73.0f,   -58.0f, 131.0f,   35.0f, -81.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  ) 
  rcanglenn_[4][9]=arrayOf<Float>(  -66.0f,   145.0f, 175.0f, -126.0f,  92.0f, -89.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  ) 
...
// 5
 ...
 rcanglenn_[5][11]=arrayOf<Float>(  -78.0f,  40.0f,   11.0f, 169.0f, 122.0f,  103.0f,  -79.0f, -64.0f, -44.0f,  -20.0f,-176.0f,   76.0f,   13.0f, 177.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  ) 
...
// 8
    ...
    rcanglenn_[8][9]=arrayOf<Float>(    44.0f,  61.0f, -96.0f, -16.0f,  -51.0f,  -73.0f,  96.0f, 144.0f,  123.0f,  -86.0f, -53.0f, -28.0f, -12.0f, -175.0f,   83.0f,    65.0f,  360.0f, 360.0f, 360.0f, 360.0f  )    
    rcanglenn_[8][10]=arrayOf<Float>( -137.0f,-117.0f,  81.0f,  50.0f,   16.0f,  171.0f, 137.0f, -73.0f,  -57.0f,  -80.0f, 126.0f, 153.0f,   8.0f,   32.0f,   73.0f,   -93.0f, -131.0f, 360.0f, 360.0f, 360.0f  )    
    rcanglenn_[8][11]=arrayOf<Float>( -158.0f,  76.0f,  25.0f, 176.0f,  135.0f,  -59.0f, -76.0f,  97.0f,  122.0f,    5.0f,  35.0f,  69.0f, -97.0f, -120.0f, -139.0f,  -156.0f,  360.0f, 360.0f, 360.0f, 360.0f  )    
...
// 9
   ...
   rcanglenn_[9][13]=arrayOf<Float>(  39.0f,  55.0f,   70.0f, -92.0f,-125.0f,  -31.0f,   -59.0f,   104.0f,  158.0f,   22.0f,   39.0f, 360.0f, 360.0f, 360.0f, 360.0f,  360.0f,360.0f, 360.0f, 360.0f, 360.0f  ) 
...
// +
      ...
      rcanglenn_[10][9]=arrayOf<Float>( 175.0f,    17.0f,  -137.0f, -74.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  )   
      rcanglenn_[10][10]=arrayOf<Float>( 45.0f,   -81.0f,   360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  )  
...
// x
  ...
  rcanglenn_[12][9]=arrayOf<Float>(   132.0f, 115.0f,  83.0f,  -52.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  )  
  rcanglenn_[12][10]=arrayOf<Float>(  129.0f, -93.0f, -53.0f,  -70.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f, 360.0f  )  
