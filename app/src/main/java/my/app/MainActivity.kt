...
class MainActivity : AppCompatActivity() {
 ...
 //     private var rcanglenn0_ = Array(20) { Array(60){ Array<Int>(20){360} } }  
  ...
  private var  rcanglenn_[0][21]=Array<Int>( -46, -62, -84,  94,  114, 136,   8,   40,   55,   74, -92, -131, -162,   -6,  -25, 360, 360, 360, 360, 360  ) 
  private var  rcanglenn_[0][22]=arrayOf<Int>( -41, -61, -80,  93,  108, 134, 156,    9,   39,   55,  78,  -98, -120, -136, -152, -13, -45, 360, 360, 360  ) 
private var rcanglenn_[0][23]=arrayOf<Int>( -55, -70,  94, 111,    8,  44,  61,  -94, -120, -140,-168,   -6,  360,  360,  360, 360, 360, 360, 360, 360  )
private var    rcanglenn_[0][24]=arrayOf<Int>( -53, -68,  95, 111,  127, 153, 170,    8,   50,   71, -98, -126, -162,  -12,  -38, -66, 360, 360, 360, 360  ) 
private var    rcanglenn_[0][25]=arrayOf<Int>(  -7, -33, -56, -77,   97, 116, 131,  158,   17,   53,  73,  -95, -113, -160,  360, 360, 360, 360, 360, 360  )
private var    rcanglenn_[0][26]=arrayOf<Int>( -75,  96, 112, 131,  170,  13,  30,   49,   66,   85, -92, -112, -130, -152,   -6, -38 Array, -54, 360, 360, 360  ) 
private var    rcanglenn_[0][27]=arrayOf<Int>(  62,  41, 170, 121,  -85, -66, -50,  -19, -166, -118,-100,   87,   64,  360,  360, 360, 360, 360, 360, 360  )
private var    rcanglenn_[0][28]=arrayOf<Int>(-162,  -7, -38, -63,  -85,  94, 111,  127,   15,   56,  71,  360,  360,  360,  360, 360, 360, 360, 360, 360  ) 
private var    rcanglenn_[0][29]=arrayOf<Int>(-173, -18, -34, -62,   93, 112, 131,    7,   32,   49,  68,   83,  360,  360,  360, 360, 360, 360, 360, 360  )
private var    rcanglenn_[0][30]=arrayOf<Int>( -39, -59, -75,  92,  109, 134, 159,    6,   45,   62,  78,  -93, -121, -149,   -6, -56, 360, 360, 360, 360  ) 
private var    rcanglenn_[0][31]=arrayOf<Int>( -31, -49, -64,  96,  126, 142, 158,    5,   39,   68, -95, -118, -140,  -12,  360, 360, 360, 360, 360, 360  )
private var    rcanglenn_[0][32]=arrayOf<Int>( -37, -54, -76,  96,  120, 148, 167,    9,   30,   46,  65,   84,  -95, -113, -137,-154,  -7, -27, 360, 360  )
private var    rcanglenn_[0][33]=arrayOf<Int>( -32, -49, -67,  95,  120, 135, 152,  167,    4,   19,  39,   54,   73,  -93, -112,-139,-159,  -5, -22, -38  )
private var    rcanglenn_[0][34]=arrayOf<Int>( -24, -51, -70,  96,  117, 139,   7,   51,   67,  -91,-107, -122, -165,  360,  360, 360, 360, 360, 360, 360  )
