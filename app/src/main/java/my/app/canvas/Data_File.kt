...
class Data_File @JvmOverloads constructor(
 ...
 fun init0() {
  ...
  //0 vs 6  [6,0]=371
   rcanglenn_[0][256] =arrayOf<Int>(-47,-66,-84,93,113,128,146,167,4,32,63,81,-91,-124,-167,-6,-32,-52,360,360)
...
// 7
   ...
   //7 vs 0  [0,80]=557   09:00 16-03-2024
rcanglenn_[7][59]=arrayOf<Int>(-111,84,59,17,173,60,77,-96,-60,-80,98,123,177,360,360,360,360,360,360,360)
...
// 8
   ...
   //8 vs 0  [0,89]=1589
    rcanglenn_[8][29] =arrayOf<Int>(-11,-166,-147,-126,-111,74,34,19,164,-77,-61,96,167,11,34,58,-110,-155,360,360)
